    ...
    <section className="tips__section">
      ...
      <div className="tips__list">
        <div className="tips__article">
          ...
          <p>
            {' '}
            Je jasné, že když se potřebujete dostat rychlo do Kanady, musíte
            ...
            no při cestování platí, že cesta je cíl (😉) Pokud ale musíte letět,
            zvolte raději let bez přestupu. Je to právě start a přistání, které
            produkují nejvíc CO2. <br />
            “čím dál se chystáte, tím více CO2 vyprodukujete”
            <br />
            Vykompenzujte svou uhlíkovou stopu. Některé aerolinky již nabízí
            možnost přikoupit kompenzaci přímo s letenkou nebo můžete využít
            takzvané offsetové organizace. Tyto společnosti pak vaše peníze
            investují do projektů zaměřených třeba na obnovitelné zdroje
            energie, výsadbu lesů, a jiné prospěšné projekty. Například, při
            zpátečním letu Praha – New York, připadá na osobu kolem 1,7 tuny
            CO2. Vykompenzování této uhlíkové stopy stojí kolem 400 Kč. Seznam
            offsetových organizací najdete tady.
            <br />
        ...
        <div className="tips__article">
          ...
          <p>
            ...
            poděkuje vám nejen naše planeta, ale i vaše peněženka.
            <br />
            ...
            věcí na cestování využijte e-shop https://www.zerowejst.cz/, Stačí
            si zakoupit jeden z nabízených produktů, který projekty českých
            neziskovek podpoří.
            <br />
        ...
        <div className="tips__article">
          ...
          <p>
            ...
            udržitelnosti. Může se jednat například o certifikáty EarthCheck,
            Green Globe, Rainforest Alliance nebo Green Tourism. Tyto
            certifikáty znamenají, že daný hotel se snaží dodržovat jisté
        ...
        <div className="tips__article">
          ...
          <p>
            ...
            když odcházíte. Místo koupele se sprchujte, nebo se koupejte ve dvou
            (😉). K napuštění vany je potřeba kolem 200 litrů vody, při
            sprchování minete v průměru 40 litrů.
            <br />
            ...
            prostředky na čištění a vodu na praní ručníků.
          </p>
        </div>
        <div className="tips__article">
        ...
        <div className="tips__article">
          ...
          <p>
            ...
            https://www.happycow.net/ ta pomůže především těm z vás, kdo jste se
            rozhodli stravovat rostlinně. Filtruje nejen restaurace, ale i
            obchody nebo třeba tržnice. Navíc jsou všude hodnocení, takže se
            nemusíte bát, že byste se spálili.
            <br />
            ...
            přírodu. Když má členství v International Ecotourism Society, chová
